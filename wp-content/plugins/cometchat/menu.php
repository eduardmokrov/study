    ...
    <div class="tabs">
        ...
        <div class="tab-content">
            <div id="cc_adminpanel" class="tab active">
                <iframe id="admin_iframe" src="<?php echo $admin; ?>" style=" width:100%;height:400px;px;border: 0; position: relative;"  scrolling="no" onload= "cc_iFrameSize();"></iframe>
            </div>
